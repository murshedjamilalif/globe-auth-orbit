...
const HomePage: React.FC = () => {
  ...
  const Logos = {
    tailwindcss: () => <svg className={'h-[28px] sm:w-auto w-[140px]'} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 262 33">
    ...
    nextjs: () => <svg className={'h-[20px] fill-primary'} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 394 79">
    ...
    framer: () => <div className={'h-fit flex items-center justify-start font-bold text-xl gap-3'}>
    ...
    aws: () => <svg className={'h-[40px]'} version="1.1" viewBox="-45.101 -44.95 390.872 269.7">
  ...
  function TerminalDemo() {
    return <Terminal className="w-full shadow-xl shadow-blue-500/10">
  ...
  const techLogos = [Logos.tailwindcss, Logos.framer, Logos.nextjs, Logos.aws];
  return <div className="min-h-screen bg-black text-white overflow-hidden">
      {/* Hero Section with Gemini Effect */}
      <section ref={geminiRef} className="relative min-h-[150vh] w-full">
        ...
        <div className="absolute inset-x-0 top-0 h-screen flex flex-col items-center z-20 my-0">
          ...
          <div className="mt-[70vh] flex flex-col items-center w-full px-4">
            ...
            duration: 0.5,
            delay: 0.6
          }} className="w-full flex justify-center my-[60px] py-0 rounded-none px-0">
              ...
              scale: 0.98
                ...
                <Link to="/practice" className="relative px-14 py-7 bg-gradient-to-r from-blue-700 to-blue-900 hover:from-blue-600 hover:to-blue-800 rounded-full font-bold text-white flex items-center shadow-2xl group border border-blue-600/50 text-xl overflow-hidden">
                  <span className="absolute inset-0 bg-gradient-to-r from-white/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 my-0 py-0 font-normal text-sm text-justify"></span>
        ...
        <div className="absolute top-[140vh] left-0 right-0 flex justify-center z-20 px-4 my-[42px] mx-0">
          <motion.div initial={{
          opacity: 0,
          y: 20
        }} animate={{
          ...
          duration: 0.8
            ...
            icon: '🔄',
            hoverGlow: 'green'
          }].map((skill, index) => <motion.div key={skill.name} initial={{
            opacity: 0,
            y: 20
          }} animate={{
            opacity: 1,
            ...
            scale: 1.05,
            y: -5,
            boxShadow: skill.hoverGlow === 'blue' ? '0 0 30px rgba(59, 130, 246, 0.5)' : skill.hoverGlow === 'yellow' ? '0 0 30px rgba(251, 191, 36, 0.5)' : skill.hoverGlow === 'red' ? '0 0 30px rgba(239, 68, 68, 0.5)' : skill.hoverGlow === 'green' ? '0 0 30px rgba(16, 185, 129, 0.5)' : '0 0 30px rgba(255, 255, 255, 0.5)'
        ...
        <div className="absolute top-[155vh] left-0 right-0 z-20 px-4 my-[49px]">
          <motion.div initial={{
          opacity: 0,
          y: 20
        }} animate={{
        ...
        duration: 1,
        delay: 2
      }} className="absolute bottom-10 left-0 right-0 w-full z-30 py-0 mx-0 my-0">
          <div className="bg-black/20 backdrop-blur-sm py-0 mx-0 my-[50px]">
            <Marquee speed={30} className="h-16">
              {techLogos.map((Logo, index) => <div key={index} className="relative h-full w-fit mx-[4rem] flex items-center justify-start">
                  <Logo />
                </div>)}
            </Marquee>
          </div>
      ...
      <section className="relative py-24 px-4 md:px-8 lg:px-16 bg-gradient-to-b from-black to-gray-900 mt-[80vh]">
        <div className="max-w-7xl mx-auto">
          ...
          once: true,
          margin: "-100px"
        }} variants={container} className="text-center mb-16">
            <motion.h2 variants={item} className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent">
              Features Built for Developers
            </motion.h2>
            <motion.p variants={item} className="text-gray-300 text-lg max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => <motion.div key={feature.title} variants={item} initial="hidden" whileInView="show" viewport={{
            once: true,
            margin: "-50px"
          }} className="bg-gray-900/50 backdrop-blur-sm border border-gray-800 p-8 rounded-2xl hover:shadow-lg hover:shadow-blue-500/5 transition-all duration-300">
